...
//Constructor to initialize the game window and video mode pointers to null.
...
GraphicService::~GraphicService() {
	onDestroy(); //Calls onDestroy to clean up resources
}
...
//Creates a new SFML RenderWindow object with specific video mode and title.
