...
namespace UI
{
	namespace MainMenu //nested namespace since everything in MainMenu exists inside UI
	{
		...
		{
			/*
			Don't worry about the static_cast. We'll discuss it later. For now, know that this function is just scaling our background image based on the size of the game window. 
			*/
